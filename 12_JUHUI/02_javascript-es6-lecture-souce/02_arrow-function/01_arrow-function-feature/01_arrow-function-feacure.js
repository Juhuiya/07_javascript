...
const theater = {
  ...
  showMovieList() {
    ...
    this.titles.forEach(function (title) {
      console.log(this); // => 일반 함수의 this는 전역객체(global)를 가리킨다. //node라 전역객체가 global. 어디의 전역객체인지 확인해야 함.
...
// this 바인딩 문제(전역 객체 or undefined를 가리킴)을 더 간편하게 해결 할 수 있다.